...
public class LoweEasel extends PApplet {
...
public void draw() {
  ...
  case EASEL_BRUSH_STANDARD:
    text("STANDARD CIRCLE", 20, height - MAX_WIDTH * 2.5f + (FONT_SIZE * 2));
    break;
  case EASEL_BRUSH_STANDARD_SQUARE:
    text("STANDARD SQUARE", 20, height - MAX_WIDTH * 2.5f + (FONT_SIZE * 2));
    break;
  case EASEL_BRUSH_OUTLINE:
    text("CIRCLE OUTLINED", 20, height - MAX_WIDTH * 2.5f + (FONT_SIZE * 2));
    break;
  case EASEL_BRUSH_FIVE_X_AXIS_OUTLINE:
    text("FIVE POINT HORIZONTAL OUTLINED CIRCLE", 20, height - MAX_WIDTH * 2.5f + (FONT_SIZE * 2));
    break;
  case EASEL_BRUSH_FIVE_X_AXIS:
    text("FIVE POINT HORIZONTAL CIRCLE", 20, height - MAX_WIDTH * 2.5f + (FONT_SIZE * 2));
    break;
  case EASEL_BRUSH_FIVE_Y_AXIS:
    text("FIVE POINT VERTICAL CIRCLE", 20, height - MAX_WIDTH * 2.5f + (FONT_SIZE * 2));
    break;
  case EASEL_BRUSH_FIVE_Y_AXIS_OUTLINE:
    text("FIVE POINT VERTICAL OUTLINED CIRCLE", 20, height - MAX_WIDTH * 2.5f + (FONT_SIZE * 2));
    break;

  case EASEL_BRUSH_SPLATTER:
    text("SPLATTER CIRCLE", 20, height - MAX_WIDTH * 2.5f + (FONT_SIZE * 2));
    break;

  case EASEL_BRUSH_SPLATTER_OUTLINE:
    text("SPLATTER OUTLINED CIRCLE", 20, height - MAX_WIDTH * 2.5f + (FONT_SIZE * 2));
    break;
  case EASEL_BRUSH_GRAFFITI:
    text("CIRCLE GRAFFITI", 20, height - MAX_WIDTH * 2.5f + (FONT_SIZE * 2));
    break;
  case EASEL_BRUSH_FIVE_X_AXIS_MOTION:
    text("FIVE POINT MOVING CIRCLE", 20, height - MAX_WIDTH * 2.5f + (FONT_SIZE * 2));
    break;
  case EASEL_BRUSH_OUTLINE_SQUARE:
    text("SQUARE OUTLINED", 20, height - MAX_WIDTH * 2.5f + (FONT_SIZE * 2));
    break;
  case EASEL_BRUSH_FIVE_X_AXIS_OUTLINE_SQUARE:
    text("FIVE POINT HORIZONTAL OUTLINED SQUARE", 20, height - MAX_WIDTH * 2.5f + (FONT_SIZE * 2));
    break;
  case EASEL_BRUSH_FIVE_X_AXIS_SQUARE:
    text("FIVE POINT HORIZONTAL SQUARE", 20, height - MAX_WIDTH * 2.5f + (FONT_SIZE * 2));
    break;
  case EASEL_BRUSH_FIVE_Y_AXIS_SQUARE:
    text("FIVE POINT VERTICAL SQUARE", 20, height - MAX_WIDTH * 2.5f + (FONT_SIZE * 2));
    break;
  case EASEL_BRUSH_FIVE_Y_AXIS_OUTLINE_SQUARE:
    text("FIVE POINT VERTICAL OUTLINED SQUARE", 20, height - MAX_WIDTH * 2.5f + (FONT_SIZE * 2));
    break;

  case EASEL_BRUSH_SPLATTER_SQUARE:
    text("SPLATTER SQUARE", 20, height - MAX_WIDTH * 2.5f + (FONT_SIZE * 2));
    break;

  case EASEL_BRUSH_SPLATTER_OUTLINE_SQUARE:
    text("SPLATTER OUTLINED SQUARE", 20, height - MAX_WIDTH * 2.5f + (FONT_SIZE * 2));
    break;
  case EASEL_BRUSH_GRAFFITI_SQUARE:
    text("SQUARE GRAFFITI", 20, height - MAX_WIDTH * 2.5f + (FONT_SIZE * 2));
    break;
  case EASEL_BRUSH_FIVE_X_AXIS_MOTION_SQUARE:
    text("FIVE POINT MOVING SQUARE", 20, height - MAX_WIDTH * 2.5f + (FONT_SIZE * 2));
    break;
...
public void saveArt() {
  ...
  text("to retrieve it", 20, height - MAX_WIDTH * 2 + (FONT_SIZE * 13.1f));
...
class Palette { 
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "--present", "--window-color=#666666", "--hide-stop", "LoweEasel" };
    if (passedArgs != null) {
